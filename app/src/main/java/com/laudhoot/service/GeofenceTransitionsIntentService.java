...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected static final String name = "geofence-transitions-service";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            String errorMessage = String.valueOf(geofencingEvent.getErrorCode());/*GeofenceErrorMessages.getErrorString(this,
                    geofencingEvent.getErrorCode());*/
            Log.e(Laudhoot.LOG_TAG, errorMessage);
            return;
        }
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            Log.i(Laudhoot.LOG_TAG, geofenceTransitionDetails);
        } else {
            // Log the error.
            Log.e(Laudhoot.LOG_TAG, getString(R.string.geofence_transition_invalid_type,
                    geofenceTransition));
        }
    }
